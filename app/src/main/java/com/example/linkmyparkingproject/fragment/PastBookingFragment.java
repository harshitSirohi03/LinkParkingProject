...
public class PastBookingFragment extends Fragment {
    @BindView(R.id.rv_pastBooking)
    RecyclerView rv_pastBooking;
    ...
    private void setUpData() {
        ...
        rv_pastBooking.setLayoutManager(new LinearLayoutManager(getContext()));
        pastBookingAdapter=new PastBookingAdapter(getContext(),pastBookingModelList);
        rv_pastBooking.setAdapter(pastBookingAdapter);
    }
}
